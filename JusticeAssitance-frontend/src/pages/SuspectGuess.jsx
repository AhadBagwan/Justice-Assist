...
// // A new component to render the detailed analysis results
...
//             {/* You can add more detailed views here if needed, parsing the 'detailed' object */}
//         </div>
//     );
// };
...
//     const [analysisResult, setAnalysisResult] = useState(null); // Will store the object from the backend
...
//     // 👇 LOGIC UPDATED TO CALL THE BACKEND API
...
//                 }
//             );
//             setAnalysisResult(response.data); // Store the full response object
//         } catch (err) {
