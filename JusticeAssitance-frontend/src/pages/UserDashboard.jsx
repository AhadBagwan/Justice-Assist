...
// // UPDATED: Simplified the status tracker as requested
...
// const ReportCard = ({ report, onViewAnalysis }) => (
...
//             {/* NEW: "View AI Analysis" button, only shown when analyzed */}
//             {report.status.toLowerCase() === 'analyzed' && (
//                 <button className="analysis-btn" onClick={() => onViewAnalysis(report.report_id)}>
//                     View AI Analysis
//                 </button>
//             )}
//             <button className="view-details-btn">Generate PDF</button>
//         </div>
//     </div>
// );
...
//     // NEW: Function to fetch detailed analysis and open the modal
...
//                 setIsModalOpen(true);
//             } else {
//                 alert(`Could not fetch details: ${response.data.message}`);
//             }
//         } catch (err) {
//             console.error("Failed to fetch report details:", err);
//             alert("An error occurred while fetching the report details.");
//         }
//     };
...
//                                     report={report} 
//                                     onViewAnalysis={handleViewAnalysis} // Pass the handler function
//                                 />
//                             ))
//                         ) : (
...
//             {isModalOpen && (
//                 <AnalysisModal 
//                     reportDetails={selectedReportDetails} 
