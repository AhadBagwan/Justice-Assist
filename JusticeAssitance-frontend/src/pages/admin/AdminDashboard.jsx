...
// // Register Chart.js components needed for a filled line chart
...
//             // Set loading to true every time the period changes
//             setIsLoading(true);
//             setError('');
...
//                 // This now extracts the specific error message from the backend response.
...
//         fetchDashboardData();
//     }, [timePeriod]); // This effect re-runs whenever 'timePeriod' changes
...
//     // The error container will now show the detailed error message
